...
function Socials() {
  ...
  const socials: social[] = [{ src: "www.github.com/abd-ulbasit", icon: FaGithub }, { src: "www.linkedin.com/in/abd-ulbasit", icon: FaLinkedin }, { src: "www.twitter.com/abd_lbasit", icon: FaTwitter }, { src: "mailto:basit01035@gmail.com", icon: FaEnvelope }]
  return <span
